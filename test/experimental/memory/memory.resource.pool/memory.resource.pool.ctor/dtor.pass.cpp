...
int main()
{
    test_allocate<unsynchronized_pool_resource>();
    test_allocate<synchronized_pool_resource>();

    test_no_allocate<unsynchronized_pool_resource>();
    test_no_allocate<synchronized_pool_resource>();
}
