...
function(add_libcxx_runtime name type)
  ...
  if (NOT LIB_ARCHS)
    message(WARNING "NO ARCHS ${LIB_ARCHS}")
    return()
  endif()
  if (APPLE)
    ...
    foreach(arch ${LIB_ARCHS})
      ...
      if(type STREQUAL "STATIC")
        set(libname "${name}${san_name}-${arch}${LIBCXX_OS_SUFFIX}")
        set(output_path_${libname} "${libname}")
      else()
        set(libname "${name}${san_name}-dynamic-${arch}${LIBCXX_OS_SUFFIX}")
        set(output_path_${libname} "${name}${san_name}-${arch}${LIBCXX_OS_SUFFIX}")
